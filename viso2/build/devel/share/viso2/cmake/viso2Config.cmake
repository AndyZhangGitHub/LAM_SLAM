...
if(viso2_CONFIG_INCLUDED)
  return()
endif()
set(viso2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(viso2_SOURCE_PREFIX /home/Andy/catkin_limo_ws/src/viso2)
  set(viso2_DEVEL_PREFIX /home/Andy/catkin_limo_ws/src/viso2/build/devel)
  set(viso2_INSTALL_PREFIX "")
  set(viso2_PREFIX ${viso2_DEVEL_PREFIX})
else()
  set(viso2_SOURCE_PREFIX "")
  set(viso2_DEVEL_PREFIX "")
  set(viso2_INSTALL_PREFIX /usr/local)
  set(viso2_PREFIX ${viso2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'viso2' is deprecated")
...
set(viso2_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/Andy/catkin_limo_ws/src/viso2/include;/usr/include/png++;/usr/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(viso2_INCLUDE_DIRS "")
  set(_include_dirs "/home/Andy/catkin_limo_ws/src/viso2/include;/usr/include/png++;/usr/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/Andy/catkin_limo_ws/src/viso2/build/devel/lib;/home/Andy/catkin_limo_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(viso2_LIBRARY_DIRS ${lib_path})
      list(APPEND viso2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'viso2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND viso2_LIBRARIES ${lib})
    endif()
  endif()
...
set(viso2_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${viso2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 viso2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${viso2_dep}_FOUND)
      find_package(${viso2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${viso2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(viso2_INCLUDE_DIRS ${${viso2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(viso2_LIBRARIES ${viso2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${viso2_dep}_LIBRARIES})
  _list_append_deduplicate(viso2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(viso2_LIBRARIES ${viso2_LIBRARIES})

  _list_append_unique(viso2_LIBRARY_DIRS ${${viso2_dep}_LIBRARY_DIRS})
  list(APPEND viso2_EXPORTED_TARGETS ${${viso2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${viso2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
