...
if(keyframe_bundle_adjustment_CONFIG_INCLUDED)
  return()
endif()
set(keyframe_bundle_adjustment_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(keyframe_bundle_adjustment_SOURCE_PREFIX /home/Andy/catkin_limo_ws/src/limo/keyframe_bundle_adjustment)
  set(keyframe_bundle_adjustment_DEVEL_PREFIX /home/Andy/catkin_limo_ws/src/limo/keyframe_bundle_adjustment/build/devel)
  set(keyframe_bundle_adjustment_INSTALL_PREFIX "")
  set(keyframe_bundle_adjustment_PREFIX ${keyframe_bundle_adjustment_DEVEL_PREFIX})
else()
  set(keyframe_bundle_adjustment_SOURCE_PREFIX "")
  set(keyframe_bundle_adjustment_DEVEL_PREFIX "")
  set(keyframe_bundle_adjustment_INSTALL_PREFIX /usr/local)
  set(keyframe_bundle_adjustment_PREFIX ${keyframe_bundle_adjustment_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'keyframe_bundle_adjustment' is deprecated")
...
set(keyframe_bundle_adjustment_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/Andy/catkin_limo_ws/src/limo/keyframe_bundle_adjustment/include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/usr/local/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(keyframe_bundle_adjustment_INCLUDE_DIRS "")
  set(_include_dirs "/home/Andy/catkin_limo_ws/src/limo/keyframe_bundle_adjustment/include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/usr/local/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/Andy/catkin_limo_ws/src/limo/keyframe_bundle_adjustment/build/devel/lib;/home/Andy/catkin_limo_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(keyframe_bundle_adjustment_LIBRARY_DIRS ${lib_path})
      list(APPEND keyframe_bundle_adjustment_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'keyframe_bundle_adjustment'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND keyframe_bundle_adjustment_LIBRARIES ${lib})
    endif()
  endif()
...
set(keyframe_bundle_adjustment_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${keyframe_bundle_adjustment_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "robust_optimization;matches_msg_types")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 keyframe_bundle_adjustment_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${keyframe_bundle_adjustment_dep}_FOUND)
      find_package(${keyframe_bundle_adjustment_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${keyframe_bundle_adjustment_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(keyframe_bundle_adjustment_INCLUDE_DIRS ${${keyframe_bundle_adjustment_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(keyframe_bundle_adjustment_LIBRARIES ${keyframe_bundle_adjustment_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${keyframe_bundle_adjustment_dep}_LIBRARIES})
  _list_append_deduplicate(keyframe_bundle_adjustment_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(keyframe_bundle_adjustment_LIBRARIES ${keyframe_bundle_adjustment_LIBRARIES})

  _list_append_unique(keyframe_bundle_adjustment_LIBRARY_DIRS ${${keyframe_bundle_adjustment_dep}_LIBRARY_DIRS})
  list(APPEND keyframe_bundle_adjustment_EXPORTED_TARGETS ${${keyframe_bundle_adjustment_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${keyframe_bundle_adjustment_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
